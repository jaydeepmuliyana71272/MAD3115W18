...
class BookCVC: UICollectionViewController {

    let booksTitles = ["The Alchemist", "The story of an hour", "Breaking Dawn", "A Jury of her Peers", "The Last Leaf", "The Day I Stopped Drinking Milk", "O Monte Cinco", "Red Queen", "The Sky is Falling", "The Neckless", "The Wise & Otherwise"]
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.lblBookName.text = booksTitles[indexPath.row]
